package org.zkoss.zkscala.lib.test.models {
	...
	import org.zkoss.zkscala.lib.models.ListModelList

	import java.util.UUID

	class ListModelListSuite extends FunSuite with BeforeAndAfterEachFunctions {
		

		val listModel = new ListModelList[String]
